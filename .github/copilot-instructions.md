...
- When committing changes, be succinct in your commit messages to clearly communicate the purpose of the change and use conventional commit message formatting (e.g., `feat: add new assignment template`, `fix: correct typo in README`)
